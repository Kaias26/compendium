...
class FlashMessenger
{
    ...
    public function set_flash_message(string $type, string $message): void
    {
    ...
    public function display_flash_messages(): string
    {
        $output = '';
        if (isset($_SESSION[self::SESSION_KEY])) {
            foreach ($_SESSION[self::SESSION_KEY] as $flash_message) {
...
" .
    ...
    public function clear_flash_messages(): void
    {
